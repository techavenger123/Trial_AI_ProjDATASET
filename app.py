...
Dependencies:
    pip install flask lightgbm scikit-learn pandas numpy
...
def train_model(cfg: dict):
    ...
    print(f"\n🔧  Training with config: lr={cfg['learning_rate']}, "
...
if __name__ == "__main__":
    print("=" * 56)
    print("  FaultSense — Equipment Fault Predictor")
    print("=" * 56)
    ...
    print(f"\n  Config  : lr={cfg['learning_rate']}, n_est={cfg['n_estimators']}")
